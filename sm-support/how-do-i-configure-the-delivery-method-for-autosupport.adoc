...
*** *Opcional:* Si desea realizar una prueba de configuración.) La dirección de correo electrónico a la que se envía una confirmación cuando el sistema AutoSupport recibe el mensaje de prueba.
